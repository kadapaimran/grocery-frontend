...
import "../styles/Products/SnacksPage.css";
...
const SnacksPage = () => {
  ...
  useEffect(() => {
    const fetchSnackProducts = async () => {
      ...
      setError(null);
      try {
        // Fetch products specifically for "snacks" category
        const data = await getProducts("snacks");
        setProducts(data || []);
      } catch (err) {
        console.error("Failed to fetch snack products:", err);
        setError("Failed to load snack products. Please try again later.");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="snacks-container">
      ...
      <nav className="breadcrumb">
        ...
        <span className="breadcrumb-separator">›</span>
        <span className="breadcrumb-current">Snacks</span>
      </nav>
      ...
      <header className="snacks-header">
        <div className="header-content">
          ...
          <div className="header-text">
            <h1>Delicious Snack Collection</h1>
            <p className="header-description">
              Tasty, satisfying snacks perfect for any time of day - from healthy options to indulgent treats
            </p>
          </div>
        </div>
      ...
      <div className="snacks-controls">
        <div className="search-wrapper">
          ...
          <input
            ...
            aria-label="Search snack products"
          />
        </div>
      ...
      {filteredProducts.length === 0 ? (
        ...
        <>
          ...
          <section className="products-section">
            <h2 className="section-title">All Snack Products</h2>
            <div className="snacks-grid">
              {filteredProducts.map((product) => (
                <article key={product.id} className="snack-card">
                  ...
                  <div className="card-content">
                    ...
                    {product.flavor && (
                      <div className="product-flavor">
                        ...
                        <span className="flavor-value">{product.flavor}</span>
                      </div>
                    )}
